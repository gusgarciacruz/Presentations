...
- Many developing countries are characterized by the prevalence of housing informality, labor informality and informality of transport
...
- Our unit of analysis are the analytical regions, which are homogeneous regions that are defined in terms of (Duque et al., 2012):
<p style="margin-bottom: -1em">
	- neighborhood limits
	- socioeconomic characteristics
	- each unit contains at least 100 household
	
- These analytical regions are calculated using the Max-p-regions technique (Duque et al., 2012), which guarantees statistical representativeness and minimizes intraregional heterogeneity 
...
<center><spam style="font-size:90%">**Figure 4. Spatial distribution of the control variables**
...
<center><spam style="font-size:90%">**Figure 5. Bivariate map of housing informality and labor informality**</center>
```{r, echo=FALSE, out.width="60%",fig.align='center'}
...
**<center><spam style="font-size:90%">Figure 6. Bivariate LISA map of housing informality and labor informality**</center>
...
**<span style="color:#2a326b"><span style= "font-size:100%">In search of the missing links**</center>
<br>
<br>
<br>

#<div class="my-logo-right"></div> 
Slides in [html](https://gusgarciacruz.github.io/Presentations/BIS/PresentacionComfama.html)
